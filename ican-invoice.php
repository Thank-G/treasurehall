...
<head>
    ...
    <title>ICAN PAYMENT INVOICE</title>
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            ...
                            <div class="row pb-5 p-5">
                                <div class="col-md-6">
                                    <p class="font-weight-bold mb-4">ICAN PAYMENT INVOICE</p>
                            ...
                            <div class="d-flex flex-row-reverse bg-dark text-white p-4">
                                <div class="py-3 px-5 text-right">
                                    <div class="mb-2 pr-5">Grand Total</div>
                                    <div class="h2 font-weight-light-bold pr-3">₦58,800</div>
                                </div>
                            </div>
                        </div>
                    </div>
