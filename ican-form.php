                            ...
                            <form class="needs-validation" novalidate>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <label for="financial reporting" class="mr-3">FINANCIAL REPORTING</label>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <input type="checkbox" name="audit_insurance" id="auditInsurance">
                                        <label for="audit and insurance" class="mr-3">AUDIT AND INSURANCE</label>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <input type="checkbox" name="performance_mgt" id="performanceMgt">
                                        <label for="performance management" class="mr-3">PERFORMANCE MANAGEMENT</label>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <input type="checkbox" name="public_sector" id="publicSector">
                                        <label for="public sector accounting and finance" class="mr-3">PUBLIC SECTOR ACCT AND FINANCE</label>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <input type="checkbox" name="corporate_strategic" id="corporateMgt">
                                        <label for="corporate strategic management & ethics" class="mr-3">CORPORATE STRATEGIC MGT AND ETHICS</label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <label for="corporate reporting" class="mr-3">CORPORATE REPORTING</label>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <input type="checkbox" name="adv_insurance" id="advInsurance">
                                        <label for="adv audit and insurance" class="mr-3">ADV. AUDIT AND ASSURANCE</label>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <input type="checkbox" name="strategic_finance" id="strategicFinMgt">
                                        <label for="strategic finance management" class="mr-3">STRATEGIC FIN. MGT</label>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <input type="checkbox" name="advance_taxtation" id="advancedTaxation">
                                        <label for="advanced taxation" class="mr-3">ADVANCED TAXATION</label>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <input type="checkbox" name="case_study" id="caseStudy">
                                        <label for="case study" class="mr-3">CASE STUDY</label>
                                    </div>
                                </div>
